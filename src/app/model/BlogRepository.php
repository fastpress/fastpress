...
class BlogRepository extends BaseModel{

    function getAll(){
    	$stmt = $this->pdo->query("SELECT title, slug, tags, content, date_added, DATE_FORMAT(date_added, '%W %m, %Y') as day_name FROM blogs"); 
